...
public class NewChannelRequest extends ServerRequest{
    @JsonProperty
    ...
    public NewChannelRequest(@JsonProperty("message") String message,@JsonProperty("sender") PrivateUser sender) {
